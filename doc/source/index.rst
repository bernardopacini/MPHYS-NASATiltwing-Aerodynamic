...
.. warning::
   ...
   This script assumes familiarity with OpenFOAM / DAFoam, OpenMDAO, and the MACH / MPhys framework and tools.
   Be sure to review and familiarize yourself with these tools before embarking on this optimization.
